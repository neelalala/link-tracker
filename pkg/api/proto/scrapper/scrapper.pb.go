...
const file_scrapper_proto_rawDesc = "" +
	"\n" +
	"\x0escrapper.proto\x12\bscrapper\x1a\x1bgoogle/protobuf/empty.proto\"%\n" +
	...
	"\n" +
	"RemoveLink\x12\x1b.scrapper.RemoveLinkRequest\x1a\x16.scrapper.LinkResponseBaZ_gitlab.education.tbank.ru/backend-academy-go-2025/homeworks/link-tracker/pkg/api/proto/scrapperb\x06proto3"
...
var file_scrapper_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
