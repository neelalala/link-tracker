...
func (x *LinkUpdate) GetAuthor() string {
	if x != nil {
		return x.Author
	}
	return ""
...
const file_bot_proto_rawDesc = "" +
	"\n" +
	"\tbot.proto\x12\x03bot\x1a\x1bgoogle/protobuf/empty.proto\"\x88\x01\n" +
	"\n" +
	"LinkUpdate\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription\x12\x1e\n" +
	"\vtg_chat_ids\x18\x04 \x03(\x03R\ttgChatIds\x12\x16\n" +
	"\x06author\x18\x05 \x01(\tR\x06author2C\n" +
	"\n" +
	"BotService\x125\n" +
	"\n" +
	"SendUpdate\x12\x0f.bot.LinkUpdate\x1a\x16.google.protobuf.EmptyB\\ZZgitlab.education.tbank.ru/backend-academy-go-2025/homeworks/link-tracker/pkg/api/proto/botb\x06proto3"
