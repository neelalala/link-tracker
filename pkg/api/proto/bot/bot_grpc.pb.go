...
type BotServiceClient interface {
	SendUpdate(ctx context.Context, in *LinkUpdate, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *botServiceClient) SendUpdate(ctx context.Context, in *LinkUpdate, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type BotServiceServer interface {
	SendUpdate(context.Context, *LinkUpdate) (*emptypb.Empty, error)
...
func (UnimplementedBotServiceServer) SendUpdate(context.Context, *LinkUpdate) (*emptypb.Empty, error) {
